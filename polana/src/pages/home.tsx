    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 mix-blend-difference text-[#FAF8F5] p-6 flex justify-between items-center font-sans tracking-widest text-xs uppercase">
        ...
        <div className="flex items-center gap-6">
          <Link href="/amber-rye" className="text-secondary hover:text-[#FAF8F5] transition-colors hidden md:block">Amber & Rye &rarr;</Link>
          <a href="#visit" className="border-b border-current pb-1 hover:opacity-70 transition-opacity">Book Table</a>
        </div>
      </nav>
      ...
      <footer id="visit" className="bg-foreground text-background py-24 px-6 md:px-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <h4 className="font-sans uppercase tracking-widest text-sm text-secondary mb-6">After Dark</h4>
            <Link href="/amber-rye" className="font-sans font-light opacity-90 hover:opacity-100 hover:text-secondary transition-colors block mb-2">
              Visit Amber & Rye &rarr;
            </Link>
          </div>
